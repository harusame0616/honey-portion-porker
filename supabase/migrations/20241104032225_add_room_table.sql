...
create table "honey_portion_porker"."room" (
    ...
    "ownerRoomId" uuid not null default gen_random_uuid(),
...
CREATE UNIQUE INDEX "room_ownerRoomId_key" ON honey_portion_porker.room USING btree ("ownerRoomId");
...
alter table "honey_portion_porker"."room"
add constraint "room_ownerRoomId_key" UNIQUE using index "room_ownerRoomId_key";
