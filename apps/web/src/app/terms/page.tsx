...
export const metadata: Metadata = {
	description: "Honey Portion Pokerの利用規約",
				...
				<div className="prose prose-slate max-w-none space-y-6">
					...
					<section>
						...
						<ol className="list-decimal pl-6 space-y-2">
							<li>
								本利用規約（以下「本規約」といいます）は、◯◯◯◯（以下「当方」といいます）が提供する「Honey
								Portion Poker」（以下「本サービス」といいます）の利用条件を定めるものです。
							</li>
							<li>
								本サービスを利用されるすべてのユーザー（以下「ユーザー」といいます）は、本規約に同意したものとみなされます。
							</li>
							<li>
								当方は、必要に応じて本規約を変更することができます。変更後の規約は、本サービス上に掲示した時点より効力を生じるものとします。
							</li>
						</ol>
					</section>

					<section>
						<h2 className="text-2xl font-bold mt-8 mb-4">第2条（サービス内容）</h2>
						<ol className="list-decimal pl-6 space-y-2">
							<li>
								本サービスは、オンライン上でプランニングポーカーを実施できるWebサービスです。
							</li>
							<li>
								本サービスは、ユーザー登録なしで利用できます。
							</li>
							<li>
								ルームは最終アクセスから30日間保存されます。この期間を過ぎたルームは予告なく削除される場合があります。
							</li>
						</ol>
					</section>

					<section>
						<h2 className="text-2xl font-bold mt-8 mb-4">第3条（禁止事項）</h2>
						...
						<ol className="list-decimal pl-6 space-y-2">
							...
							<li>ボットその他の自動化された手段によって本サービスにアクセスまたは利用する行為</li>
							<li>その他、当方が不適切と判断する行為</li>
						</ol>
					</section>

					<section>
						<h2 className="text-2xl font-bold mt-8 mb-4">第4条（本サービスの提供の停止等）</h2>
						<ol className="list-decimal pl-6 space-y-2">
							<li>
					...
					<section>
						<h2 className="text-2xl font-bold mt-8 mb-4">第5条（利用制限および登録抹消）</h2>
						<ol className="list-decimal pl-6 space-y-2">
							<li>
					...
					<section>
						<h2 className="text-2xl font-bold mt-8 mb-4">第6条（免責事項）</h2>
						<ol className="list-decimal pl-6 space-y-2">
							<li>
								当方は、本サービスに事実上または法律上の瑕疵（安全性、信頼性、正確性、完全性、有効性、特定の目的への適合性、セキュリティなどに関する欠陥、エラーやバグ、権利侵害などを含みます。）がないことを明示的にも黙示的にも保証しておりません。
							</li>
							<li>
								当方は、本サービスに起因してユーザーに生じたあらゆる損害について、一切の責任を負いません。ただし、本サービスに関する当方とユーザーとの間の契約（本規約を含みます。）が消費者契約法に定める消費者契約となる場合、この免責規定は適用されません。
							</li>
							<li>
					...
					<section>
						<h2 className="text-2xl font-bold mt-8 mb-4">第7条（サービス内容の変更等）</h2>
						<p>
					...
					<section>
						<h2 className="text-2xl font-bold mt-8 mb-4">第8条（利用規約の変更）</h2>
						<ol className="list-decimal pl-6 space-y-2">
							<li>
					...
					<section>
						<h2 className="text-2xl font-bold mt-8 mb-4">第9条（個人情報の取扱い）</h2>
						<p>
					...
					<section>
						<h2 className="text-2xl font-bold mt-8 mb-4">第10条（通知または連絡）</h2>
						<p>
					...
					<section>
						<h2 className="text-2xl font-bold mt-8 mb-4">第11条（権利義務の譲渡の禁止）</h2>
						<p>
